...
urlpatterns = [
    ...
    path('location/<int:pk>/uuid/', views.LocationUuidView.as_view(), name='locationuuid'),
    path('location/<int:pk>/uuid/change/', views.location_uuid_change, name='locationuuidchange'),
